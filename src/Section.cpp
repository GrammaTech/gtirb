...
Section::Section(std::string n, uint64_t s, EA ea)
    : Node(), name(n), size(s), startingAddress(ea) {}

const std::string& Section::getName() const { return this->name; }

const uint64_t Section::getSize() const { return this->size; }

const EA Section::getStartingAddress() const { return this->startingAddress; }
