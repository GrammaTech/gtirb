...
TEST(Unit_Utilities, ByteArray8To16)
{
    ...
    ASSERT_NO_THROW(gtirb::util::ByteArray8To16(input));

    const auto output = gtirb::util::ByteArray8To16(input);
...
TEST(Unit_Utilities, ByteArray8To16Swap)
{
    ...
    const auto output = gtirb::util::ByteArray8To16(input, true);
...
TEST(Unit_Utilities, ByteArray8To16Error)
{
    ...
    EXPECT_THROW(gtirb::util::ByteArray8To16(input), std::range_error);
}
