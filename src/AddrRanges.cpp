...
void AddrRanges::clearRanges() { this->ranges.clear(); }

void AddrRanges::swap(gtirb::AddrRanges& x) { this->ranges.swap(x.ranges); }

std::map<gtirb::EA, gtirb::EA>::const_iterator
AddrRanges::getFirstIntersecting(gtirb::EA lb, gtirb::EA ub) const {
...
std::map<gtirb::EA, gtirb::EA>& AddrRanges::data() { return this->ranges; }

const std::map<gtirb::EA, gtirb::EA>& AddrRanges::data() const { return this->ranges; }
