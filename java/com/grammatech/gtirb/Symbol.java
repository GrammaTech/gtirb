...
public class Symbol extends Node {
    ...
    private long value;
    private com.grammatech.gtirb.proto.SymbolOuterClass.Symbol.OptionalPayloadCase payload_type;

    public Symbol(com.grammatech.gtirb.proto.SymbolOuterClass.Symbol protoSymbol) {
        ...
        if (this.payload_type
                == com.grammatech.gtirb.proto.SymbolOuterClass.Symbol.OptionalPayloadCase.VALUE) {
            this.value = protoSymbol.getValue();
            this.referentUuid = Util.NIL_UUID;
        } else if (this.payload_type
                == com.grammatech.gtirb.proto.SymbolOuterClass.Symbol.OptionalPayloadCase
                        .REFERENT_UUID) {
