...
struct adjacency_list_traits {
  ...
  typedef
      typename parallel_edge_traits<OutEdgeListS>::type edge_parallel_category;
...
private:
  ...
  typedef
      typename detail::adj_list_gen<self, VertexListS, OutEdgeListS, DirectedS,
                                    vertex_property_type, edge_property_type,
                                    GraphProperty, EdgeListS>::type Base;
